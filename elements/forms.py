...
class ElementForm(forms.Form):
    ...
    title = forms.CharField(label="Título", max_length=255, min_length=3, validators=[MinLengthValidator(10, message='Muy corto! (minino %(limit_value)d) actual %(show_value)d ')]  ) 
